...
# read data
dataframe = pd.read_csv("data/Simple_Avoided_Crossing/005/transmission/12.0.data",header=None, delim_whitespace=True)
...
dataframe_ehr = pd.read_csv("data/Simple_Avoided_Crossing/ehrenfest/005/ehr.12.0.csv", usecols=col_to_read, delimiter=',')
dataframe_ehr_minus = pd.read_csv("data/Simple_Avoided_Crossing/ehrenfest/005/ext_ehr_minus.12.0.csv", usecols=col_to_read,  delimiter=',')
dataframe_ehr_plus = pd.read_csv("data/Simple_Avoided_Crossing/ehrenfest/005/ext_ehr_plus.12.0.csv", usecols=col_to_read,  delimiter=',')
dataframe_ehr_CG = pd.read_csv("data/Simple_Avoided_Crossing/ehrenfest/005/ehrenfest_CG.12.0.csv", usecols=col_to_read,  delimiter=',')
...
plt.legend(['ED','Ehr','Ehr min','Ehr plus','Ehr CG'])
plt.savefig('pop_dynamics_TullyA_C5_12k.png', dpi=300)
plt.show()
